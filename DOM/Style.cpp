...
const PropertyValue<RaylibColor> DefaultStyle::backgroundColor{"backgroundColor", RAYLIB_RAYWHITE};
...
const PropertyValue<float> DefaultStyle::borderWidth{"borderWidth", 1.0f};
const PropertyValue<int> DefaultStyle::borderRadius{"borderRadius", 0};
const PropertyValue<int> DefaultStyle::fontSize{"fontSize", 20};
